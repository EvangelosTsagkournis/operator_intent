...
CalculateArucoDistance::CalculateArucoDistance() : it_(nh_)
{
  ...
  sync.registerCallback(boost::bind(&CalculateArucoDistance::callBack, _1, _2));
  */
...
void CalculateArucoDistance::callBack(const sensor_msgs::ImageConstPtr &image, const operator_intent_msgs::marker_locationsConstPtr &markers)
{
